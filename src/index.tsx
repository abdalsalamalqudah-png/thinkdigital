    ...
    <script>
        ...
        async function handleLogin(event) {
            ...
            try {
                ...
                if (response.ok) {
                    alert('تم تسجيل الدخول بنجاح! مرحباً ' + (data.user?.name || email));
                    hideSection('login');
                } else {
                    alert(data.message || 'فشل تسجيل الدخول');
                }
            } catch (error) {
                alert('نعمل على تفعيل نظام تسجيل الدخول. يمكنك تجربة الحسابات التجريبية المذكورة.');
            }
        }
        ...
        async function handleRegister(event) {
            ...
            try {
                ...
                alert('نعمل على تفعيل نظام التسجيل. يمكنك تجربة الحسابات التجريبية.');
            }
        }
    </script>
</body>
